...
month_summary <- month_summary %>% mutate(month_name = month.name[month])
...
ggplot(month_summary,
       aes(x = month_name, y = mean_dryMass_per_day, color = functionalGroup, group = functionalGroup)) +
  geom_point() +
  geom_line()
  labs(x = "Month", y = "Mean dry litter mass (g/day)", color = "Litter Source Functional Group", title = "Daily Litterfall Accumulation in Bartlett Experimental Forest")
