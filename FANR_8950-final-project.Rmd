...
#Replicating plot without the October outlier
...
ggplot(month_summary_no_outlier,
  ...
  geom_bar(stat= "identity", position = "dodge") +
  scale_fill_brewer(palette = "Dark2")  +
  labs(x = "Month", y = "Mean dry litter mass (g/day)", fill = "Litter Source", title = "Daily Litterfall Accumulation in Bartlett Experimental Forest, 2016", subtitle = "October high leaf-fall outlier removed")
