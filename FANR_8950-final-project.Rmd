...
##### Leaves appear to make up the bulk of litter in October and November, with needles, twigs/branches, and other(unspecified) dominating the rest of the year.
...
#### *Considerations*: It should be noted that this report analyzes dry mass (g), not relative abundance, of each litter source. The sources that appear to make up a greater amount of the mass of each 
